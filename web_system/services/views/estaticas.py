...
from services.serializers.calculo import CalculoSerializer
from rest_framework import status


@api_view(['GET'])
def saudacao(request):
    return Response({"saudação": "Olá Mundo"})
...
class ExemplosSaudacao(APIView):
    def get(self, resquest):
        return Response({"saudacao": "ola mundo em classe"})
